...
class Tracker:
    ...
    def draw_ellipse(self,frame,bbox,color,track_id):
        ...
        cv2.ellipse(frame,(x_center,y2),(int(width),int(0.35*width)),0,startAngle=0,endAngle=235,color=color,thickness=2,lineType=cv2.LINE_4)
    ...
    def draw_annotations(self,video_frames,tracks,team_ball_control):
        ...
        for frame_num,frame in enumerate(video_frames):
            ...
            for track_id,referee in referee_dict.items():
                frame=self.draw_ellipse(frame,referee["bbox"],(255,0,0),track_id)
